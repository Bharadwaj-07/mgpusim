...
def main():
    ...
    concurrentworkload = Test(benchmarks_path + 'concurrentworkload')
    ...
    # err |= concurrentworkload.compile()
    err |= conv2d.compile()
    # err |= color.compile()
